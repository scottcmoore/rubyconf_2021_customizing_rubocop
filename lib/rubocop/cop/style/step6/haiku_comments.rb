  ...
  module Cop
    module Style
      ...
      class HaikuComments < RuboCop::Cop::Cop
        def_node_matcher :poetic_method?, '(def _method_name _method_args `(send _receiver :puts #poetic?))'
        ...
        def on_def(node)
          ...
          return if node.nil? # There wasn't a matching node in the ast_with_comments
