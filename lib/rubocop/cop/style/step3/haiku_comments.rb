  ...
  module Cop
    module Style
      ...
      class HaikuComments < RuboCop::Cop::Cop
        ...
        def on_def(node)
          # First, print the node name (the name of the defined method) and any comments associated with it.
          # Second, add an offense if the method definition doesn't have three comment lines.
        end
      end
    end
  end
